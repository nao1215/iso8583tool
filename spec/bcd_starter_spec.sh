...
Describe 'iso8583tool spec87bcd-starter preset'
  ...
  It 'packs and round-trips an EMV TLV tag (55.9F02)' # bug 07
  ...
  It 'packs a raw PIN field (52)' # bug 08
  ...
  It 'packs and round-trips a raw MAC field (64)' # bug 09
  ...
  It 'round-trips a variable-length field with a BCD length prefix (32)' # bug 10
