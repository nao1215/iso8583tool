...
Describe 'iso8583tool validate --strict advice and network rules'
  ...
  It 'fails a hollow authorization advice (0120)' # bug 15
  ...
  It 'fails a hollow financial advice (0220)' # bug 16
  ...
  It 'fails a hollow network advice (0820)' # bug 17
  ...
  It 'fails a hollow network response (0810)' # bug 47
  ...
  It 'fails a hollow network advice response (0830)' # bug 48
