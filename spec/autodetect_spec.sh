...
Describe 'iso8583tool input auto-detection'
  ...
  It 'views a raw binary capture without --encoding raw' # bug 37
  ...
  It 'validates a raw binary capture without --encoding raw' # bug 37
    write_kanmu_like_message "$WORK/raw.bin"
  ...
  It 'converts a raw binary capture without --encoding raw' # bug 37
    write_kanmu_like_message "$WORK/raw.bin"
  ...
  It 'reads an all-numeric raw ASCII capture as raw, not packed hex' # bug 38
