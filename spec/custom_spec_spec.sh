...
Describe 'iso8583tool custom JSON spec import'
  ...
  It 'loads a top-level Hex field and round-trips it' # bug 01
  ...
  It 'loads a Hex TLV subfield' # bug 02
  ...
  It 'loads a Track1 field' # bug 03
  ...
  It 'loads a Track3 field' # bug 04
  ...
  It 'loads an IndexTag composite subfield' # bug 05
  ...
  It 'loads a composite tag that omits sort' # bug 06
