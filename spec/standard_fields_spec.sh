...
Describe 'iso8583tool standard high-numbered fields'
  ...
  It 'packs and round-trips fields 95/96/100/102/103/104' # bug 49
  ...
  It 'packs the reserved fields 123-127' # bug 50
  ...
  It 'packs and round-trips the binary MAC field 128' # bug 50
